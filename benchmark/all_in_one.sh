...
RUSTUP_TOOLCHAIN=nightly-2023-06-02
...
for d in */; do
    ...
    # RUN CLIPPY FIX
    (cd "${d}" && cargo clippy --fix --allow-dirty --allow-no-vcs) >>clippy_fix.log 2>&1
